...
function plus!(robot)   #Функция перемещает робота по всем возможным крестам на поле, вызывая функцию cross_move для каждого креста, после чего ставит маркер
